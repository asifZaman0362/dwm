...
static const char *fonts[] = {"Martian Mono:size=14"};
static const char dmenufont[] = "Martian Mono:size=14";
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_p, spawn, {.v = dmenu_cmd_desktop}},
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_q, quitprompt, {0}},
};
